...
DOCKER_DIR_GENERATE := $(if $(BIND_DIR),-v "/home/ml/$(BIND_DIR)")
DOCKER_MOUNT := $(if $(BIND_DIR),-v "$(CURDIR)/$(BIND_DIR):/home/ml/$(BIND_DIR)")

DOCKER_MOUNT := $(if $(DOCKER_MOUNT),$(DOCKER_MOUNT),-v "/home/ml/$(BIND_DIR)")
